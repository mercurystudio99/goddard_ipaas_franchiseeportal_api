...
using FranchiseePortal.Test.Base.TestData;
...
namespace FranchiseePortal.Test.Base
{
    ...
    /// Provides methods to easily work with <see cref="FranchiseePortalDbContext"/>.
    /// </summary>
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        {
            void NormalizeDbContext(FranchiseePortalDbContext context)
            {
        ...
        protected void UsingDbContext(Action<FranchiseePortalDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<FranchiseePortalDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected TResult UsingDbContext<TResult>(Func<FranchiseePortalDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<FranchiseePortalDbContext, Task<TResult>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<FranchiseePortalDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<FranchiseePortalDbContext>())
                {
                    action(context);
                    context.SaveChanges();
                }
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<FranchiseePortalDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<FranchiseePortalDbContext>())
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<FranchiseePortalDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<FranchiseePortalDbContext, Task<TResult>> func)
        {
            TResult result;
