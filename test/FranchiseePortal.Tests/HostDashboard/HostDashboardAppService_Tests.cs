...
using FranchiseePortal.MultiTenancy.HostDashboard;
...
namespace FranchiseePortal.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FranchiseePortalDbContext context, SubscriptionPayment subscriptionPayment)
        {
