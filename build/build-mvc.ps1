...
$webMvcFolder = Join-Path $slnFolder "src/FranchiseePortal.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/FranchiseePortal.Web.Public"
...
dotnet restore FranchiseePortal.Web.sln
