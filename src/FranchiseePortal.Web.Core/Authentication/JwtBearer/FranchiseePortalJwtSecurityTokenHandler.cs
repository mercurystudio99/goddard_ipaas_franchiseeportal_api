...
namespace FranchiseePortal.Web.Authentication.JwtBearer
{
    public class FranchiseePortalJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FranchiseePortalJwtSecurityTokenHandler()
        {
