...
using FranchiseePortal.Web.Configuration;
using FranchiseePortal.Web.DashboardCustomization;

namespace FranchiseePortal.Web
{
    [DependsOn(
    ...
    public class FranchiseePortalWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FranchiseePortalWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FranchiseePortalApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FranchiseePortalWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FranchiseePortalWebCoreModule).Assembly);
        }
