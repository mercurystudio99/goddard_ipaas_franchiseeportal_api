...
namespace FranchiseePortal.ToursWebApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AvailabilityBlockDto")]
    public partial class AvailabilityBlockDto : IEquatable<AvailabilityBlockDto>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailabilityBlockDto" /> class.
        /// </summary>
        ...
        public AvailabilityBlockDto(DayOfWeek? dayOfWeek = default(DayOfWeek?), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), List<TourTypesEnum> tourTypes = default(List<TourTypesEnum>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AvailabilityBlockDto {\n");
        ...
        {
            return this.Equals(input as AvailabilityBlockDto);
        }

        /// <summary>
        /// Returns true if AvailabilityBlockDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AvailabilityBlockDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailabilityBlockDto input)
        {
            if (input == null)
            {
                return false;
