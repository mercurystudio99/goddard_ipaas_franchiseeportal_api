...
namespace FranchiseePortal.TestimonialsWebApiClient.Model
{
    ...
    /// TestimonialDto
    /// </summary>
    [DataContract(Name = "TestimonialDto")]
    public partial class TestimonialDto : IEquatable<TestimonialDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestimonialDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestimonialDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestimonialDto" /> class.
        /// </summary>
        ...
        public TestimonialDto(bool activeFlag = default(bool), long? id = default(long?), long fmsSchoolId = default(long), string content = default(string), string displayName = default(string), string children = default(string), int ordinal = default(int), string program = default(string), string relationship = default(string), string headline = default(string), string parent = default(string), long parentID = default(long), string systinoSurveyResponseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestimonialDto {\n");
        ...
        {
            return this.Equals(input as TestimonialDto);
        }

        /// <summary>
        /// Returns true if TestimonialDto instances are equal
        /// </summary>
        /// <param name="input">Instance of TestimonialDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestimonialDto input)
        {
            if (input == null)
                return false;
