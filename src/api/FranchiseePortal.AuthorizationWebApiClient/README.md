# FranchiseePortal.AuthorizationWebApiClient - the C# library for the Goddard.AuthorizationApi
...
------------ | ------------- | ------------- | -------------
*AuthorizedSchoolsApi* | [**ApiV1AuthorizedSchoolsGet**](docs/AuthorizedSchoolsApi.md#apiv1authorizedschoolsget) | **GET** /api/v1/authorized-schools | 


<a name="documentation-for-models"></a>
## Documentation for Models

 - [Model.AuthorizedSchool](docs/AuthorizedSchool.md)
