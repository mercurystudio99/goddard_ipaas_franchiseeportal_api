...
namespace FranchiseePortal.LeadsWebApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_school_leads_internal_post_request")]
    public partial class ApiV1SchoolLeadsInternalPostRequest : IEquatable<ApiV1SchoolLeadsInternalPostRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1SchoolLeadsInternalPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV1SchoolLeadsInternalPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1SchoolLeadsInternalPostRequest" /> class.
        /// </summary>
        ...
        public ApiV1SchoolLeadsInternalPostRequest(string homePhone = default(string), string workPhone = default(string), long? schoolParentLeadId = default(long?), long schoolId = default(long), string firstName = default(string), string lastName = default(string), string streetLine1 = default(string), string city = default(string), string zipCode = default(string), string mobilePhone = default(string), string emailAddress = default(string), ReferredBy referredBy = default(ReferredBy), DateTime startDate = default(DateTime), int contactPreference = default(int), List<ChildLead> schoolChildLeads = default(List<ChildLead>), string additionalRemarks = default(string), List<string> programsOfInterest = default(List<string>), List<DaysOfInterest> daysOfInterest = default(List<DaysOfInterest>))
        {
            this.SchoolId = schoolId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "zipCode" is required (not null)
            if (zipCode == null)
            {
                throw new ArgumentNullException("zipCode is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
            this.ZipCode = zipCode;
            // to ensure "mobilePhone" is required (not null)
            if (mobilePhone == null)
            {
                throw new ArgumentNullException("mobilePhone is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
            this.MobilePhone = mobilePhone;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("schoolChildLeads is a required property for ApiV1SchoolLeadsInternalPostRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV1SchoolLeadsInternalPostRequest {\n");
        ...
        {
            return this.Equals(input as ApiV1SchoolLeadsInternalPostRequest);
        }

        /// <summary>
        /// Returns true if ApiV1SchoolLeadsInternalPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiV1SchoolLeadsInternalPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiV1SchoolLeadsInternalPostRequest input)
        {
            if (input == null)
            {
                return false;
