...
namespace FranchiseePortal.LeadsWebApiClient.Model
{
    ...
    /// TourLeadInputDto
    /// </summary>
    [DataContract(Name = "TourLeadInputDto")]
    public partial class TourLeadInputDto : IEquatable<TourLeadInputDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TourLeadInputDto" /> class.
        /// </summary>
        ...
        public TourLeadInputDto(List<TourLeadChildInput> schoolChildLeads = default(List<TourLeadChildInput>), List<DaysOfInterest> daysOfInterest = default(List<DaysOfInterest>), List<string> programsOfInterest = default(List<string>), string tourQuestions = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TourLeadInputDto {\n");
        ...
        {
            return this.Equals(input as TourLeadInputDto);
        }

        /// <summary>
        /// Returns true if TourLeadInputDto instances are equal
        /// </summary>
        /// <param name="input">Instance of TourLeadInputDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TourLeadInputDto input)
        {
            if (input == null)
            {
                return false;
