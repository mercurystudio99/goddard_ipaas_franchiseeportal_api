...
namespace FranchiseePortal.LeadsWebApiClient.Model
{
    ...
    /// FranchiseLead
    /// </summary>
    [DataContract(Name = "FranchiseLead")]
    public partial class FranchiseLead : IEquatable<FranchiseLead>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FranchiseLead" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FranchiseLead() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FranchiseLead" /> class.
        /// </summary>
        ...
        public FranchiseLead(string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), string zip = default(string), string comments = default(string), ContactPreferences? userOptedIn = default(ContactPreferences?), string ipAddress = default(string), string gaCampaign = default(string), string gaClientID = default(string), string gaLandingPage = default(string), string gaMedium = default(string), string gaSource = default(string), string gRecaptchaResponse = default(string), int liquidity = default(int), List<int> leadMarketsofInterest = default(List<int>), string otherMarketsofInterest = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for FranchiseLead and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for FranchiseLead and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for FranchiseLead and cannot be null");
            }
            this.Email = email;
            // to ensure "phone" is required (not null)
            if (phone == null)
            {
                throw new ArgumentNullException("phone is a required property for FranchiseLead and cannot be null");
            }
            this.Phone = phone;
            // to ensure "zip" is required (not null)
            if (zip == null)
            {
                throw new ArgumentNullException("zip is a required property for FranchiseLead and cannot be null");
            }
            this.Zip = zip;
            // to ensure "gRecaptchaResponse" is required (not null)
            if (gRecaptchaResponse == null)
            {
                throw new ArgumentNullException("gRecaptchaResponse is a required property for FranchiseLead and cannot be null");
            }
        ...
        {
            return this.Equals(input as FranchiseLead);
        }

        /// <summary>
        /// Returns true if FranchiseLead instances are equal
        /// </summary>
        /// <param name="input">Instance of FranchiseLead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FranchiseLead input)
        {
            if (input == null)
            {
                return false;
