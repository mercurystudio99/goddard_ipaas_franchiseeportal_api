...
namespace FranchiseePortal.ContentWebApiClient.Model
{
    ...
    public partial class Entity : IEquatable<Entity>, IValidatableObject
    {
        ...
        public Entity(List<string> _class = default(List<string>), Dictionary<string, Object> properties = default(Dictionary<string, Object>), List<Entity> entities = default(List<Entity>), List<Link> links = default(List<Link>), List<Action> actions = default(List<Action>), string title = default(string), List<string> rel = default(List<string>), string href = default(string), string type = default(string))
        {
            this.Class = _class;
