...
namespace FranchiseePortal.SchoolEventsWebApiClient.Model
{
    ...
    /// PostEvents
    /// </summary>
    [DataContract(Name = "PostEvents")]
    public partial class PostEvents : IEquatable<PostEvents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEvents" /> class.
        /// </summary>
        ...
        public PostEvents(long? id = default(long?), long fmsSchoolId = default(long), string title = default(string), string startDateTime = default(string), string endDateTime = default(string), bool isAllDay = default(bool), bool isShownOnPublicWebsite = default(bool), bool isHighlighted = default(bool), string iconFileName = default(string), string description = default(string), long? createdByUserId = default(long?), string publicWebSiteDescription = default(string), string recurringParameterPrimary = default(string), string recurringParameterSecondary = default(string), string recurringParameterFirst = default(string), string recurringParameterSecond = default(string), string recurringParameterThird = default(string), string recurringParameterFourth = default(string), string recurringParameterRangeStart = default(string), string recurringParameterRangeType = default(string), string recurringParameterRangeQualifier = default(string), string seriesID = default(string), bool activeFlag = default(bool), int eventType = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PostEvents);
        }

        /// <summary>
        /// Returns true if PostEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of PostEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostEvents input)
        {
            if (input == null)
                return false;
