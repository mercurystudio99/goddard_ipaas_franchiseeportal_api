...
using FranchiseePortal.Web.Startup.ExternalLoginInfoProviders;
...
namespace FranchiseePortal.Web.Startup
{
    ...
    public class FranchiseePortalWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FranchiseePortalWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FranchiseePortalWebHostModule).GetAssembly());
        }
    ...
    public class ExtendedMicrosoftExternalLoginInfoProvider : MicrosoftExternalLoginInfoProvider {
        public string TenantId { get; set; }

        public ExtendedMicrosoftExternalLoginInfoProvider(string consumerKey, string consumerSecret, string tenantId) : base(consumerKey, consumerSecret) {
            TenantId = tenantId;
            ExternalLoginProviderInfo.AdditionalParams.Add("tenantId", TenantId);
        }
