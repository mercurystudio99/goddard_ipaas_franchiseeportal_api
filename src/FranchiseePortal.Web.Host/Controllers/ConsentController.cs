...
using FranchiseePortal.Web.Models.Consent;

namespace FranchiseePortal.Web.Controllers
{
    public class ConsentController : FranchiseePortalControllerBase
    {
        ...
        /// <returns></returns>
        /// <remarks>
        /// 20220105RBP - FIX: Changed method to private to avoid swagger generation error:
        /// "SwaggerGeneratorException: Conflicting method/path combination "GET Consent/CreateScopeViewModel" for actions - FranchiseePortal.Web.Controllers.ConsentController.CreateScopeViewModel (FranchiseePortal.Web.Host),FranchiseePortal.Web.Controllers.ConsentController.CreateScopeViewModel (FranchiseePortal.Web.Host). Actions require a unique method/path combination for Swagger/OpenAPI 3.0. Use ConflictingActionsResolver as a workaround"
        /// </remarks>
