...
{
    public class FranchiseePortalDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string TopToolsAndResources = "Widgets_Host_TopToolsAndResources";
                public const string YourInsights = "Widgets_Tenant_YourInsights";
                public const string MarketingTools = "Widgets_Tenant_MarketingTools";
            }
