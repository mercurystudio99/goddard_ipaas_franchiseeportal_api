...
namespace FranchiseePortal.Migrations
{
    ...
    [Migration("20220223235757_Add_UpdateInsightSortOrder_StoredProc")]
    partial class Add_UpdateInsightSortOrder_StoredProc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FranchiseePortal.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FranchiseePortal.Insights.Insight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FranchiseePortal.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FranchiseePortal.ResourceLinks.ResourceLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FranchiseePortal.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FranchiseePortal.Authorization.Users.User", null)
                        .WithMany("Claims")
