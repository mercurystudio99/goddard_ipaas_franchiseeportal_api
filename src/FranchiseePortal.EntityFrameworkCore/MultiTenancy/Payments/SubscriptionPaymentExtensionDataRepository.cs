...
{
    public class SubscriptionPaymentExtensionDataRepository : FranchiseePortalRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FranchiseePortalDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
