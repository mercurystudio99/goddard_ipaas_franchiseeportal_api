...
using FranchiseePortal.Authentication;
using FranchiseePortal.DashboardCustomization;
...
namespace FranchiseePortal.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!FranchiseePortalConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        FranchiseePortalConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetSharedSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.IsQuickThemeSelectEnabled,
                    ...
                    scopes: SettingScopes.Application | SettingScopes.Tenant, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(AppSettings.UserManagement.SystemAlertMessage,
                    GetFromAppSettings(AppSettings.UserManagement.SystemAlertMessage, null),
                    scopes: SettingScopes.Application | SettingScopes.Tenant, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    FranchiseePortalDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    FranchiseePortalDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = FranchiseePortalDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = FranchiseePortalDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = FranchiseePortalDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        FranchiseePortalDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = FranchiseePortalDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = FranchiseePortalDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        FranchiseePortalDashboardCustomizationConsts.Widgets.Host
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                {
                                    WidgetId = FranchiseePortalDashboardCustomizationConsts.Widgets.Tenant
                                        .TopToolsAndResources, // Top Tools
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 0
        ...
        private SettingDefinition[] GetMicrosoftExternalLoginProviderSettings()
        {
            ...
            string tenantId = GetFromSettings("Authentication:Microsoft:TenantId");
