...
{
    public class StripeGatewayManager : FranchiseePortalServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "FranchiseePortal";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FranchiseePortalConsts.Currency;
        }
