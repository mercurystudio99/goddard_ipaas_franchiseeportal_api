...
namespace FranchiseePortal.Features
{
    public class AppFeatureProvider : FeatureProvider
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AppFeatureProvider(IAppConfigurationAccessor configuration)
        {
        ...
        public override void SetFeatures(IFeatureDefinitionContext context)
        {
            ...
            var tourFeature = context.Create(
                AppFeatures.TourFeature,
                defaultValue: _appConfiguration.GetValue<string>("App:Tours:Enabled") ?? "False",
                displayName: L("TourFeature"),
                inputType: new CheckboxInputType()
            );

            var siteMarketintToolsFeature = context.Create(
                AppFeatures.SiteMarketingToolsFeature,
                defaultValue: _appConfiguration.GetValue<string>("App:SiteMarketingTools:Enabled") ?? "False",
                displayName: L("SiteMarketingToolsFeature"),
                inputType: new CheckboxInputType()
            );
        }
