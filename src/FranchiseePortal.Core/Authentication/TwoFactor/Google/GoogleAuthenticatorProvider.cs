...
namespace FranchiseePortal.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FranchiseePortalServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FranchiseePortal", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
