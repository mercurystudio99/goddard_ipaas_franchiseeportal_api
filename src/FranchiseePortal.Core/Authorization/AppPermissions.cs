namespace FranchiseePortal.Authorization
{
    ...
    {
        public const string Pages_Administration_ResourceLinks = "Pages.Administration.ResourceLinks";
        public const string Pages_Administration_ResourceLinks_Create = "Pages.Administration.ResourceLinks.Create";
        public const string Pages_Administration_ResourceLinks_Edit = "Pages.Administration.ResourceLinks.Edit";
        public const string Pages_Administration_ResourceLinks_Delete = "Pages.Administration.ResourceLinks.Delete";

        public const string Pages_Administration_Insights = "Pages.Administration.Insights";
        public const string Pages_Administration_Insights_Create = "Pages.Administration.Insights.Create";
        public const string Pages_Administration_Insights_Edit = "Pages.Administration.Insights.Edit";
        public const string Pages_Administration_Insights_Delete = "Pages.Administration.Insights.Delete";
        ...
        public const string Pages_Faculty = "Pages.Faculties";
        public const string Pages_Faculty_Edit = "Pages.Faculties.Edit";
