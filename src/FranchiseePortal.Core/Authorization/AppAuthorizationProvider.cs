...
namespace FranchiseePortal.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var resourceLinks = administration.CreateChildPermission(AppPermissions.Pages_Administration_ResourceLinks, L("ResourceLinks"));
            resourceLinks.CreateChildPermission(AppPermissions.Pages_Administration_ResourceLinks_Create, L("CreateNewResourceLink"));
            resourceLinks.CreateChildPermission(AppPermissions.Pages_Administration_ResourceLinks_Edit, L("EditResourceLink"));
            resourceLinks.CreateChildPermission(AppPermissions.Pages_Administration_ResourceLinks_Delete, L("DeleteResourceLink"));

            var insights = administration.CreateChildPermission(AppPermissions.Pages_Administration_Insights, L("Insights"));
            insights.CreateChildPermission(AppPermissions.Pages_Administration_Insights_Create, L("CreateNewInsight"));
            insights.CreateChildPermission(AppPermissions.Pages_Administration_Insights_Edit, L("EditInsight"));
            insights.CreateChildPermission(AppPermissions.Pages_Administration_Insights_Delete, L("DeleteInsight"));
            ...
            var shoolSiteEditor = pages.CreateChildPermission(AppPermissions.Pages_Faculty, L("SchoolSiteEditor"), multiTenancySides: MultiTenancySides.Tenant);
            shoolSiteEditor.CreateChildPermission(AppPermissions.Pages_Faculty_Edit, L("EditingFaculties"), multiTenancySides: MultiTenancySides.Tenant);
        }

        private static ILocalizableString L(string name)
        {
            return new LocalizableString(name, FranchiseePortalConsts.LocalizationSourceName);
        }
    }
}