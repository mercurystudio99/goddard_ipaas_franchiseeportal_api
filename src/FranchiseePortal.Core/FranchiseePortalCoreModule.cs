...
using FranchiseePortal.Authorization.Ldap;
...
using FranchiseePortal.DashboardCustomization.Definitions;
using FranchiseePortal.Debugging;
using FranchiseePortal.DynamicEntityProperties;
using FranchiseePortal.Features;
using FranchiseePortal.Friendships;
using FranchiseePortal.Friendships.Cache;
using FranchiseePortal.Localization;
using FranchiseePortal.MultiTenancy;
using FranchiseePortal.Net.Emailing;
using FranchiseePortal.Notifications;
using FranchiseePortal.WebHooks;
using Newtonsoft.Json;

namespace FranchiseePortal
{
    [DependsOn(
        typeof(FranchiseePortalCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FranchiseePortalCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FranchiseePortalLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FranchiseePortalConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FranchiseePortalMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FranchiseePortalSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FranchiseePortalCoreModule).GetAssembly());
        }
