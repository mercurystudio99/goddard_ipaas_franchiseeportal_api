...
using FranchiseePortal.Web.Public.Startup;
using FranchiseePortal.Web.Session;

namespace FranchiseePortal.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FranchiseePortalViewComponent
    {
