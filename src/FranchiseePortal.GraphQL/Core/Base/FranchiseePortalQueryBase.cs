...
namespace FranchiseePortal.Core.Base
{
    public abstract class FranchiseePortalQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected FranchiseePortalQueryBase(string fieldName,
