...
using FranchiseePortal.Core.Base;
using FranchiseePortal.Core.Extensions;
using FranchiseePortal.Dto;
using FranchiseePortal.Types;

namespace FranchiseePortal.Queries
{
    public class OrganizationUnitQuery : FranchiseePortalQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
