...
using FranchiseePortal.MultiTenancy.Payments.Paypal;
using FranchiseePortal.MultiTenancy.Payments.PayPal;
using FranchiseePortal.MultiTenancy.Payments.PayPal.Dto;

namespace FranchiseePortal.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : FranchiseePortalAppServiceBase, IPayPalPaymentAppService
    {
