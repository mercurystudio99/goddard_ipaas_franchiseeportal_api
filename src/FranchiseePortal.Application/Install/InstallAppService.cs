...
using FranchiseePortal.Migrations.Seed.Host;
...
namespace FranchiseePortal.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FranchiseePortalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FranchiseePortalDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FranchiseePortalConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FranchiseePortalConsts.ConnectionStringName}", constring);
        }
