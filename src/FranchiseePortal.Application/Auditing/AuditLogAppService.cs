...
using FranchiseePortal.Auditing.Exporting;
...
using EntityHistoryHelper = FranchiseePortal.EntityHistory.EntityHistoryHelper;

namespace FranchiseePortal.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FranchiseePortalAppServiceBase, IAuditLogAppService
    {
