...
using FranchiseePortal.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace FranchiseePortal.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : FranchiseePortalAppServiceBase, IDashboardCustomizationAppService
    {
