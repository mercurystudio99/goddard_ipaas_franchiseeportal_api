...
namespace FranchiseePortal.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : FranchiseePortalAppServiceBase, IUserDelegationAppService
    {
