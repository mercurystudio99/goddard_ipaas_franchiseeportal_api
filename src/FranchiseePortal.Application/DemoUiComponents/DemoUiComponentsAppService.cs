...
using FranchiseePortal.DemoUiComponents.Dto;

namespace FranchiseePortal.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FranchiseePortalAppServiceBase, IDemoUiComponentsAppService
    {
